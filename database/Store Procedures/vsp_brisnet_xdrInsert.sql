IF EXISTS (SELECT * FROM sysobjects 
           WHERE id = OBJECT_ID(N'[kelso].[vsp_brisnet_xdrInsert]') 
              AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
  DROP PROCEDURE [kelso].[vsp_brisnet_xdrInsert]
GO

CREATE PROCEDURE [kelso].[vsp_brisnet_xdrInsert]
AS
BEGIN
	SET NOCOUNT ON;

	INSERT INTO kelso.brisnet_xdr (
								Id,
								TrackCd,
								RaceDt,
								RaceNum,
				...
				SELECT (SELECT DRFId FROM kelso.brisnet_drf WHERE TrackCd = S.TrackCd AND RaceDt = S.RaceDt AND RaceNum = S.RaceNum),
					   S.TrackCd,
					   S.RaceDt,
					   S.RaceNum,
					   S.ReservedString1,
					   ...
					   S.ReservedString166,
					   S.ReservedString167
				FROM kelso.brisnet_xdr_staging S
				WHERE NOT EXISTS (
									SELECT *
									FROM kelso.brisnet_xdr
